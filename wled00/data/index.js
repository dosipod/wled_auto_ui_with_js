...
${inforow("Build it",i.vid)}
${inforow("Signal me",i.wifi.signal +"% ("+ i.wifi.rssi, " dBm)")}
${inforow("UpDog",getRuntimeStr(i.uptime))}
${inforow("Shor time?",i.time)}
${inforow("Free men",heap," kB")}
